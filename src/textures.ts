...
function paintTool(img: ImageData, toolId: number): void {
  ...
  if (toolId === Tool.Pickaxe) {
    // 钻石镐:青色镐头 + 木柄,轮廓按原版道具的右侧镐尖读法处理。
    const outline: Array<[number, number]> = [
      [4, 1], [5, 1], [6, 1], [7, 1], [8, 1], [9, 1],
      [2, 2], [3, 2], [10, 2], [11, 2],
      [1, 3], [2, 3], [9, 3], [10, 3], [12, 3],
      [2, 4], [7, 4], [8, 4], [10, 4], [11, 4], [12, 4],
      [3, 5], [6, 5], [8, 5], [9, 5], [11, 5], [13, 5],
      [6, 6], [7, 6], [9, 6], [11, 6], [13, 6],
      [5, 7], [6, 7], [8, 7], [11, 7], [13, 7],
      [4, 8], [5, 8], [7, 8], [11, 8], [13, 8],
      [3, 9], [4, 9], [6, 9], [11, 9], [13, 9],
      [2, 10], [3, 10], [5, 10], [11, 10], [13, 10],
      [1, 11], [2, 11], [4, 11], [11, 11], [13, 11],
      [0, 12], [1, 12], [3, 12], [11, 12], [13, 12],
      [0, 13], [2, 13], [12, 13], [13, 13],
      [1, 14], [2, 14], [12, 14],
    ];
    dots(outline, [24, 46, 48]);
    dots(
      [
        [3, 2], [4, 2], [5, 2], [6, 2], [7, 2], [8, 2], [9, 2],
        [2, 3], [3, 3], [4, 3], [5, 3], [6, 3], [7, 3],
        [3, 4], [4, 4], [5, 4],
        [11, 6], [12, 7], [12, 8], [12, 9], [12, 10],
      ],
      [88, 232, 214],
    );
    dots(
    ...
    dots(
      [
        [8, 5], [9, 5], [10, 4], [10, 6],
        [7, 6], [6, 7], [5, 8], [4, 9], [3, 10], [2, 11], [1, 12],
      ],
      [142, 96, 48],
    );
    dots(
      [
        [8, 6], [7, 7], [6, 8], [5, 9], [4, 10], [3, 11], [2, 12], [1, 13],
      ],
      [82, 54, 30],
    );
