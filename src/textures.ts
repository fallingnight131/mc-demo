...
function paintTool(img: ImageData, toolId: number): void {
  ...
  if (toolId === Tool.Pickaxe) {
    const outline: Array<[number, number]> = [
      ...
      [1, 3], [2, 3], [3, 3], [10, 3], [11, 3], [13, 3], [14, 3],
      [1, 4], [12, 4], [14, 4],
      [0, 5], [13, 5], [15, 5],
      [0, 6], [14, 6], [15, 6],
      [1, 7], [14, 7],
      [9, 6], [10, 7], [8, 7], [9, 8], [7, 8], [8, 9], [6, 9],
      [7, 10], [5, 10], [6, 11], [4, 11], [5, 12], [3, 12],
      [4, 13], [2, 13], [3, 14], [2, 14], [1, 15], [2, 15],
    ];
    dots(outline, [42, 42, 46]);
    dots(
      [
        [5, 1], [6, 1], [7, 1], [8, 1], [9, 1], [10, 1],
        [3, 2], [4, 2], [10, 2], [11, 2], [12, 3], [13, 4], [14, 5],
        [1, 5], [1, 6],
      ],
      [222, 226, 232],
    );
    ...
    dots(
      [
        [10, 7], [9, 8], [8, 9], [7, 10], [6, 11], [5, 12], [4, 13], [3, 14],
      ],
      [102, 64, 32],
    );
  } else if (toolId === Tool.Sword) {
    // 钻石剑:青蓝斜刃 + 深色护手,轮廓贴近原版道具剪影
    dots(
      [
